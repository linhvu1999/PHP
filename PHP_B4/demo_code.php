    ...
    <table border="1" cellpadding="6" cellspacing="0">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="checkbox" name="jobs[]" value="2" <?php echo $checkedJob1 ?>/> Developer <br/>
                <input type="checkbox" name="jobs[]" value="3" <?php echo $checkedJob1 ?>/> Freelancer <br/>
                <input type="checkbox" name="jobs[]" value="4" <?php echo $checkedJob1 ?>/> Tester <br/>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="2">
                Thông tin thêm <br/>
                <textarea name="information" cols="30" rows="3">
                    <?php
                    echo isset($information) ? $information : ''
                    ?>
                </textarea>
            </td>
        </tr>
